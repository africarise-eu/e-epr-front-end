    ...
    <v-col cols="12" class="d-flex align-center justify-center">
      <div class="text-center">
        <div class="ComingsoonWrapper my-6">
          <img src="@/assets/images/maintenance/under-construction.svg" alt="maintenance" class="w-100" />
        </div>
        ...
        <v-row class="ma-0">
          <v-col cols="12" class="pt-7 pb-0">
            <h6 class="text-h6 text-secondary mb-3">Be the first to be notified .</h6>
          </v-col>
